                ...
                <div className="col-xl-12">
                    <div className="card">
                        <div className="card-body pb-2">
                            <h1 className="text-center no-border font-w600 fs-60 mt-2"><span className="text-warning">Buy</span> and <span className="text-danger">Sell</span> Coins at the<br/> CRW with no additional charges</h1>
