...
const listData = [{}, {}, {}, {}, {}];
const widgetChart = [
  { id: 1, name: "Customer", quantity: "10", bgcolor: "bg-warning" },
  { id: 2, name: "Supplier", quantity: "13", bgcolor: "bg-secondary" },
  { id: 3, name: "Orders", quantity: "9", bgcolor: "bg-pink" },
  { id: 4, name: "Products", quantity: "15", bgcolor: "bg-primary" },
  { id: 4, name: "Invoice", quantity: "8", bgcolor: "bg-primary" },
  { id: 4, name: "Reports", quantity: "10", bgcolor: "bg-pink" },
  { id: 4, name: "Balance", quantity: "11", bgcolor: "bg-secondary" },
  { id: 4, name: "Sales", quantity: "18", bgcolor: "bg-warning" },
];
                ...
                <div className={`card card-box ${item.bgcolor}`}>
                  <div className="card-header border-0 pb-0">
                    <div className="chart-num-days">
                      ...
                      <h2 className="count-num text-white mb-4">{item.name}</h2>
                    </div>
                    {/* {item.id === 1 ? (
                      <svg
                        width="50"
              ...
              <div className="card">
                <div className="card-header">
                  <div className="d-flex align-items-center">
                    <h4 className="heading ms-3 mb-0">
