...
import Withdraw from "./components/Dashboard/Withdrawal/Withdraw";
import WithdrawHistory from "./components/Dashboard/Withdrawal/WithdrawHistory";
import PaymentForm from "./components/BankDetails/BankDetails";

const Markup = () => {
  const allroutes = [
    /// Dashboard
    // { url: "", component: <Home /> },
    { url: "dashboard1", component: <Home /> },
    // { url: "dashboard-dark", component: <DashboardDark /> },
    // { url: "index-1", component: <Dashboard2 /> },
    { url: "dashboard", component: <Dashboard3 /> },
    ...
    { url: "bank-details", component: <PaymentForm /> },
